...
// HERE
  function setERC721Contact() public onlyOwner{
  }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to == ownerOf(tokenId), "The given address is already the owner of the tokenId.");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        // HERE
        require(msg.sender == currentOwner() || isApprovedForAll(ownerOf(tokenId), msg.sender), "Caller could not be authorized against this token");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // HERE
        require(to != address(0), "The given TO address is invalid");
        // TODO: clear approval
        // HERE
